# Hi, I'm Sathya Vakacharla 👋

Lead AI Engineer and Technical Lead with 14+ years of enterprise software engineering discipline (React, Node.js, TypeScript) and 5+ years of Azure Cloud architecture experience, transitioning into AI Engineering. I specialize in bridging full-stack cloud microservices with production-grade, autonomous AI systems.

Currently designing and deploying deterministic, secure AI workflows using LangGraph, Model Context Protocol (MCP), Microsoft AI Foundry, Advanced RAG architectures, and Guardrail Safety Systems.
